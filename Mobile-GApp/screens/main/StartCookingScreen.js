...
const cookingData = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Season chicken breast with salt, pepper, and oregano. Grill for 6-7 minutes per side until internal temperature reaches 165F (74C).',
      duration: 15,
    ...
    },
    {
      ...
      description: 'Dice 1 cucumber, halve 1 cup of cherry tomatoes, and thinly slice 1/2 red onion.',
      duration: 5,
      image: 'https://images.unsplash.com/photo-1566385101042-1a0f0c126c96?w=400',
      ingredients: ['Cucumber', 'Cherry tomatoes (1 cup)', 'Red onion (1/2)'],
    ...
    },
    {
      ...
      ingredients: ['Cooked quinoa', 'Chopped vegetables', 'Kalamata olives (1/4 cup)'],
    ...
    },
    {
      ...
      tip: 'Balanced plate: 1/2 non-starchy veggies, 1/4 protein, 1/4 complex carbs.',
      equipment: ['None'],
    },
    {
      id: '7',
