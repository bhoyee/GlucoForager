  ...
  return (
    <div className="admin-card">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          <h2 className="admin-title">Newsletter History</h2>
          <p className="admin-subtitle">Previous newsletters sent to subscribers.</p>
        </div>
        <Link className="admin-link" href="/admin/newsletter/send">
          Back to send
        </Link>
      </div>
