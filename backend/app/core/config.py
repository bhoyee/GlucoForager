...
class Settings(BaseSettings):
    ...
    # Recipe image generation provider ("openai", "runware", or "gemini").
    # Defaults to OpenAI when available (consistent with recipe generation).
    recipe_image_provider: str = Field("openai", env="RECIPE_IMAGE_PROVIDER")
