...
def list_revenuecat_transactions(
    ...
    query = (
        ...
        # Sandbox/test-mode webhook events carry realistic-looking prices too - exclude
        # them so test purchases never show up as real revenue.
        .filter(func.lower(func.coalesce(SubscriptionEvent.environment, "")) != "sandbox")
    )
